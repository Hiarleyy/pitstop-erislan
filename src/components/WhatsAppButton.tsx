...
const WhatsAppButton = () => {
  return (
    <a
      href="https://wa.me/559180588823?text=Olá! Gostaria de mais informações sobre os serviços da PitStop Estética Automotiva." 
      target="_blank"
    ...
    >
      <div className="relative">
        ...
        {/* Main button */}
        <div className="relative p-4 rounded-full bg-gradient-to-br from-green-500 to-green-600 text-white shadow-2xl hover:from-green-600 hover:to-green-700 transition-all duration-300 transform hover:scale-110 group-hover:shadow-green-500/25">
          <svg
            className="w-7 h-7"
