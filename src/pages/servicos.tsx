import {Car, Wrench, Shield, Camera, Bike, SparkleIcon, Droplet, Lightbulb, SprayCan} from "lucide-react";
...
const Servicos = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-auto-lightgray">
        <h2 className="text-2xl text-red-600 mb-4">Erro ao carregar serviços</h2>
        <p>{error}</p>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-auto-lightgray">
      ...
      <div className="min-h-screen container mx-auto px-4 py-10">
        ...
        <h1 className="text-4xl font-bold text-center py-10 mt-10">Serviços de Higienização</h1>
        ...
        {/* SEÇÃO DE SERVIÇOS DE ESTÉTICA */}
        <h1 className="text-4xl font-bold text-center py-10 mt-10">Serviços de Estética</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
          {todosServicos
            .filter(servico => servico.categoria === "estetica")
            .map((servico, index) => (
              <Card 
              key={index} 
              className="flex-1 bg-blue-50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-blue-400 hover:bg-blue-100"
        ...
        {/* SEÇÃO DE SERVIÇOS DE INTERIORES */}
        <h1 className="text-4xl font-bold text-center py-10 mt-10">Serviços de Interiores</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
          {todosServicos
            .filter(servico => servico.categoria === "interiores")
            .map((servico, index) => (
              <Card 
              key={index} 
              className="flex-1 bg-blue-50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:border-blue-400 hover:bg-blue-100"
        ...
        <h1 className="text-4xl font-bold text-center py-10 mt-10">Serviços para moto</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
          {todosServicos
